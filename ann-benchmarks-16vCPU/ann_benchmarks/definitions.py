...
def prepare_args(run_group: Dict[str, Any]) -> List:
    ...
    """
    if "arg_groups" in run_group: # Preference arg_groups
        # Directly return the list of dicts/items from arg_groups
        # No combination generation needed for the list itself
        return run_group["arg_groups"]
    elif "args" in run_group:
        # Use generate_arg_combinations for the 'args' key as originally intended
        return generate_arg_combinations(run_group, "args")
    else:
