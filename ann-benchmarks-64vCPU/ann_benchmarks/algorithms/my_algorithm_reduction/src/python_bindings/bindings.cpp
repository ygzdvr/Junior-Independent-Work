...
class Index {
 public:
    ...
    void initProjections(size_t max_level, float target_eps = 0.10f, size_t min_dim = 32) {
        ...
        appr_alg->initProjections(max_level, target_eps, min_dim);
    }
...
PYBIND11_PLUGIN(hnswlib) {
        ...
        .def("init_projections", &Index<float>::initProjections, py::arg("max_level"), py::arg("target_eps") = 0.10f, py::arg("min_dim") = 32)
