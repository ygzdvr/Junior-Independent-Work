...
docker tag ann-benchmarks-my_algorithm_prune ann-benchmarks-my-algorithm-prune
docker tag ann-benchmarks-my_algorithm_diversity ann-benchmarks-my-algorithm-diversity
docker tag ann-benchmarks-my_algorithm_reduction ann-benchmarks-my-algorithm-reduction
#docker tag ann-benchmarks-my_algorithm_base_prune_1_15 ann-benchmarks-my-algorithm-base-prune-1-15

ALGORITHMS=(
  "my-algorithm-prune,ann-benchmarks-my-algorithm-prune"
  "my-algorithm-diversity,ann-benchmarks-my-algorithm-diversity"
  "my-algorithm-reduction,ann-benchmarks-my-algorithm-reduction"
)
