...
docker tag ann-benchmarks-my_algorithm_diversity_tight ann-benchmarks-my-algorithm-diversity-tight
docker tag ann-benchmarks-my_algorithm_diversity_loose ann-benchmarks-my-algorithm-diversity-loose
...
ALGORITHMS=(
  ...
  "my-algorithm-diversity-tight,ann-benchmarks-my-algorithm-diversity-tight"
  "my-algorithm-diversity-loose,ann-benchmarks-my-algorithm-diversity-loose"
)
