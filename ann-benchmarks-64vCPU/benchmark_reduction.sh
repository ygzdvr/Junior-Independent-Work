...
#docker tag ann-benchmarks-my_algorithm_base ann-benchmarks-my-algorithm-base
#docker tag ann-benchmarks-my_algorithm_reduction_0_3 ann-benchmarks-my-algorithm-reduction-0-3
#docker tag ann-benchmarks-my_algorithm_reduction_0_6 ann-benchmarks-my-algorithm-reduction-0-6
docker tag ann-benchmarks-my_algorithm_reduction_0_2 ann-benchmarks-my-algorithm-reduction-0-2
docker tag ann-benchmarks-my_algorithm_reduction_0_4 ann-benchmarks-my-algorithm-reduction-0-4
docker tag ann-benchmarks-my_algorithm_reduction_0_8 ann-benchmarks-my-algorithm-reduction-0-8
#docker tag ann-benchmarks-my_algorithm_base_prune_1_15 ann-benchmarks-my-algorithm-base-prune-1-15

ALGORITHMS=(
  "my-algorithm-reduction-0-2,ann-benchmarks-my-algorithm-reduction-0-2"
  "my-algorithm-reduction-0-4,ann-benchmarks-my-algorithm-reduction-0-4"
  "my-algorithm-reduction-0-8,ann-benchmarks-my-algorithm-reduction-0-8"
  "my-algorithm-base,ann-benchmarks-my-algorithm-base"
)
